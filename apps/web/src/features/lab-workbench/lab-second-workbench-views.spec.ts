...
const mocks = vi.hoisted(() => ({
  ...
  result: { create: vi.fn(), observation: vi.fn(), derivation: vi.fn(), rule: vi.fn(), adopt: vi.fn(), get: vi.fn(), status: vi.fn() },
  qc: { create: vi.fn(), result: vi.fn(), verdict: vi.fn(), impact: vi.fn(), deviation: vi.fn(), gate: vi.fn(), release: vi.fn(), get: vi.fn(), status: vi.fn() },
  report: { create: vi.fn(), line: vi.fn(), evaluate: vi.fn(), submit: vi.fn(), get: vi.fn(), gate: vi.fn(), hash: vi.fn(), issue: vi.fn(), action: vi.fn(), verification: vi.fn(), version: vi.fn() }
}))
