...
| `ATC-WEB-001@1.0.0` | `story` | `approved` | 实施 Scope、Quantity、Allocation 与 Batch 实验室工作台 | `major` | web, scope, quantity, allocation, batch, operator-workbench, accessibility, automated-test | `8e37afc7bc27` |
...
| `ATC-WEB-006@1.0.0` | `story` | `approved` | 实施 Receiving 既有对象续办 Web 入口 | `minor` | web, receiving, identity-assessment, exception, release, operator-workbench, accessibility-ui, automated-test | `080235ea3564` |
...
| `BUS-TOY-006@1.0.0` | `requirement` | `approved` | 多 TestUnit 结论的危险域覆盖与未覆盖项披露 | `major` | toy, test-unit, hazard-coverage, conformity, reporting, disclosure, external-compliance-reference | `0cf0fbbe0a7c` |
