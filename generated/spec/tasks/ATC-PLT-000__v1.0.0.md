...
| 来源 | PRD-MAIN#OD-002, PRD-MAIN#SEC-DEPLOY-001, PRD-MAIN#SEC-AUD-001, PRD-MAIN#NFR-ARCH-001, PRD-MAIN#NFR-ARCH-002, PRD-MAIN#AC-DEPLOY-001 |
| 固定依赖 | ED-001@1.0.0, ED-002@1.0.0, OD-002@1.0.0, SEC-DEPLOY-001@1.0.0, SEC-AUD-001@1.0.0, NFR-ARCH-001@1.0.0, NFR-ARCH-002@1.0.0, AC-DEPLOY-001@1.0.0 |
| 规格指纹 | `f45a6ee6de5f3a58d10e30dda8cc30c1227c57275025d8c251651b03de48be8d` |
...
- ED-001已形成approved/decided版本，并固定.NET、Node、PostgreSQL、前端、非生产身份与对象存储参考实现、测试和部署版本
- ED-002已形成approved/decided版本，并固定通用模块化单体代码与持久化边界；平台Host、building-blocks和tests夹具均遵守该边界
- OD-002@1.0.0继续有效，任务实现采用每集团独立部署且禁止共享SaaS多租户数据平面
- SEC-DEPLOY-001、SEC-AUD-001、NFR-ARCH-001、NFR-ARCH-002和AC-DEPLOY-001的1.0.0版本已完成适用性与语义评审
- 所有工程工具、包和容器锁值及其证据已经完成评审，不存在latest、范围版本或空锁值
